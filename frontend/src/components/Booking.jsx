...
const Booking = props => {
  ...
  return (
    ...
    <Container sx={{display: "flex", flexDirection:"column",  paddingTop: "50px", paddingBottom: "20px", justifyContent: "space-between"}}>
      <Paper sx={{padding: "20px"}}>
        <Typography variant="h4" sx={{ textAlign: "center", paddingBottom: "20px"}}>{listing.title}</Typography>
          <Box sx={{display: "flex", justifyContent: "space-evenly"}}>
            <Box sx={{ display: "flex", flexDirection: "column", paddingLeft: "50px", justifyContent:  "center"}}>
              <img src={listing.images[0]} alt='Main' />.
            </Box>
            <Box sx={{width: "50%",  height:"550px", display:"flex",  flexDirection:"column", justifyContent: "center"}}>
              {page === "Review" ? <ReviewBooking styles={styles} step={step} listing={listing}  next=   {next} back={back}></ReviewBooking>: ""}
