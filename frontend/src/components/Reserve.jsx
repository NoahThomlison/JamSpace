...
const Reserve = props => {
  ...
  return (
    <Box sx={{ zIndex: "2", height: 'auto', bgcolor: theme => theme.palette.mode === 'dark' ? '#101010' : '#fff', color: theme => theme.palette.mode === 'dark' ? 'grey.300' : 'grey.800', p: 1, m: 1, borderRadius: 2, textAlign: 'center', fontSize: '0.875rem', fontWeight: '700',}}>
      <Typography sx={{ fontSize: 20 }} color='text.primary' gutterBottom>Rental Dates</Typography>
       <div>
         <DateRangePicker defaultColor='#222222' format='MM-DD-YYYY' callback={callbackFunction}/>
       </div>
       <div className='mb-3'>
